...
#-------------------------------------------------------
#
# For ELSI with external ELPA support, add WITH_ELSI=1 above, and use
# lines similar to the following for symbols.
...
#
# MKLROOT should be defined upon loading the appropriate mkl module
#
