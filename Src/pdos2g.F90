  ...
  subroutine setup_Gamma()
    ...
    do io = 1,nuo
      ...
      do j = 1,numh(io)
        ...
        Haux(1,jo,1,io) = Haux(1,jo,1,io) + cmplx(H(ind,1), 0._dp,dp)
        Haux(2,jo,2,io) = Haux(2,jo,2,io) + cmplx(H(ind,2), 0._dp,dp)
        Haux(1,jo,2,io) = Haux(1,jo,2,io) + cmplx(H(ind,3),-H(ind,4),dp)
        Haux(2,jo,1,io) = Haux(2,jo,1,io) + cmplx(H(ind,3), H(ind,4),dp)
      end do
    end do
