...
!
#ifdef MPI
subroutine pdos3kp( nuo, no, maxuo, maxnh, &
  ...
  call re_alloc( numhg, 1, nuotot, name='numhg', routine= 'pdos3kp' )
  call re_alloc( listhptrg, 1, nuotot, name='listhptrg', routine= 'pdos3kp' )
  call re_alloc( listhg, 1, maxnhg, name='listhg', routine= 'pdos3kp' )
  call re_alloc( Hg, 1, 8, 1, maxnhg, name='Hg', routine= 'pdos3kp' )
  call re_alloc( Sg, 1, maxnhg, name='Sg', routine= 'pdos3kp' )
  call re_alloc( xijg, 1, 3, 1, maxnhg, name='xijg', routine= 'pdos3kp' )
  ...
  do io = 1, nuotot
    ...
    call MPI_Bcast(Hg(1,listhptrg(io)+1),8*numhg(io),MPI_Double_Precision, &
          BNode,MPI_Comm_World,MPIerror)
...
!!$OMP end parallel
  ...
  call de_alloc( xijg, name='xijg', routine= 'pdos3kp' )
  call de_alloc( Hg, name='Hg', routine= 'pdos3kp' )
  call de_alloc( Sg, name='Sg', routine= 'pdos3kp' )
  call de_alloc( listhg, name='listhg', routine= 'pdos3kp' )
  call de_alloc( listhptrg, name='listhptrg', routine= 'pdos3kp' )
  call de_alloc( numhg, name='numhg', routine= 'pdos3kp' )

  ! Allocate workspace array for global reduction
  call re_alloc( aux_red, 1, 4, 1, nuotot, 1, nhist, &
      name='aux_red', routine='pdos3kp')
  ...
  call de_alloc(aux_red, name='aux_red', routine='pdos3kp')
  ...
  subroutine setup_k(k)
    ...
    do io = 1,nuotot
      do ind = listhptrg(io) + 1, listhptrg(io) + numhg(io)
        ...
        Haux(1,jo,1,io) = Haux(1,jo,1,io) + cmplx(Hg(1,ind), Hg(5,ind), dp) * kphs
        Haux(2,jo,2,io) = Haux(2,jo,2,io) + cmplx(Hg(2,ind), Hg(6,ind), dp) * kphs
        Haux(1,jo,2,io) = Haux(1,jo,2,io) + cmplx(Hg(3,ind), -Hg(4,ind), dp) * kphs
        Haux(2,jo,1,io) = Haux(2,jo,1,io) + cmplx(Hg(7,ind), Hg(8,ind), dp) * kphs
