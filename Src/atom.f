...
!      chlocal(1)= -rhor1* zval/qtot
      ...
      chlocal(1)= ( chlocal(2)*rofi(3)**2 - chlocal(3)*rofi(2)**2 ) /
     $     ( rofi(3)**2 - rofi(2)**2 )
...
C***Internal variables**
     ...
     .           nrc2, nrc3, nrc4, ism, nrc_1st_zeta
     ...
     $           spln_min
      ...
      logical :: keep_full_higher_zetas
...
C***READING THE ENERGY-SHIFT TO DEFINE THE CUT-OFF RADIUS OF ORBITALS***
           ...
           keep_full_higher_zetas =
     $                fdf_boolean('PAO.KeepFullHigherZetas',.false.)
...
C
     ...
     .            ' and zeta=',i,' are identical for l=',l
            ...
            if (keep_full_higher_zetas) then
               ! Keep the full extent of the higher zeta orbitals
               write(6,'(a,i2,a)') 'Zeta orb ', izeta,
     $                         ' will conserve the original tail'
               nrc = nrc_1st_zeta 
               rco(izeta,l,nsm)= rco(1,l,nsm)
